...
{
    public class MeshCombinerEditor : ScriptableWizard
    {
        ...
        [MenuItem("Tools/Assistant/Mesh Combiner")]
        public static void Open()
        {
            DisplayWizard<MeshCombinerEditor>("Mesh Combiner", "Combine");
        }
